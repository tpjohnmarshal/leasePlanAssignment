...
The SUTs are external to this project. Here, we target the https://waarkoop-server.herokuapp.com to search product availability.

## FAQ

#### How can I get the project into my IDE?
Clone or download the project repository from the following GitHub link. https://github.com/tpjohnmarshal/leasePlanAssignment.git
